...
/**
 * This is the model class for table "hla_donante".
 *
 * The followings are the available columns in table 'hla_donante':
 ...
 */
class Hla_donante extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('donante_id, fecha_prueba, identificacion_prueba, locus_a_alelo_1, locus_a_alelo_2, locus_b_alelo_1_, locus_b_alelo_2, locus_dr_alelo_1, locus_dr_alelo_2', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Hla_donante the static model class
	 */
