...
/**
 * This is the model class for table "datos_personas_v".
 *
 * The followings are the available columns in table 'datos_personas_v':
 ...
 */
class Datos_personas_v extends CActiveRecord
{
	/**
	 ...
	 * @return Datos_personas_v the static model class
	 */
