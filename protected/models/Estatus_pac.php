...
/**
 * This is the model class for table "estatus_pac".
 *
 * The followings are the available columns in table 'estatus_pac':
 ...
 */
class Estatus_pac extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'pacientes' => array(self::HAS_MANY, 'Pacientes', 'estatus_id'),
		);
	}
	 ...
	 * @return Estatus_pac the static model class
	 */
