...
/**
 * This is the model class for table "estatus_pac_normal".
 *
 * The followings are the available columns in table 'estatus_pac_normal':
 * @property integer $estatus_id
 * @property string $estatus
 */
class Estatus_pac_normal extends CActiveRecord
{
	/**
	 ...
	 * @return Estatus_pac_normal the static model class
	 */
