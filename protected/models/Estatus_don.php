...
/**
 * This is the model class for table "estatus_don".
 *
 * The followings are the available columns in table 'estatus_don':
 * @property integer $estatus_id
 * @property string $estatus
 */
class Estatus_don extends CActiveRecord
{
	/**
	 ...
	 * @return Estatus_don the static model class
	 */
