...
/**
 * This is the model class for table "estatus_org".
 *
 * The followings are the available columns in table 'estatus_org':
 * @property integer $estatus_id
 * @property string $estatus
 */
class Estatus_org extends CActiveRecord
{
	/**
	 ...
	 * @return Estatus_org the static model class
	 */
